...
public interface OutboxMapper {
     ...
     * @return 影响行数（1 表示成功）
     */
    @Insert("INSERT INTO outbox (id, event_id, topic, partition_key, payload, status, retry_count, created_at, shard_id, trace_id) " +
            "VALUES (#{id}, #{eventId}, #{topic}, #{partitionKey}, #{payload}, #{status}, #{retryCount}, #{createdAt}, #{shardId}, #{traceId})")
