...
public class ContractDTO implements Serializable {
    ...
    public String toString() {
        return "ContractDTO{id=" + id + ", code='" + code + "', name='" + name + "', exchange='" + exchange + "', product='" + product + "', multiplier=" + multiplier + ", tickSize=" + tickSize + ", minQty=" + minQty + ", listedDate=" + listedDate + ", expiryDate=" + expiryDate + ", status='" + status + "'}";
    }
