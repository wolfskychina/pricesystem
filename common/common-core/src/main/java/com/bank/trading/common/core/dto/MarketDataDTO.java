...
public class MarketDataDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MarketDataDTO that = (MarketDataDTO) o;
    ...
    public String toString() {
        return "MarketDataDTO{symbol='" + symbol + "', bidPrice=" + bidPrice + ", askPrice=" + askPrice + ", lastPrice=" + lastPrice + ", bidQty=" + bidQty + ", askQty=" + askQty + ", lastQty=" + lastQty + ", volume=" + volume + ", timestamp=" + timestamp + "}";
    }
