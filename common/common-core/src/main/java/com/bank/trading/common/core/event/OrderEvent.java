...
public class OrderEvent extends BaseEvent {
    ...
    public String toString() {
        return "OrderEvent{orderId='" + orderId + "', clientOrderId='" + clientOrderId + "', customerId='" + customerId + "', symbol='" + symbol + "', side='" + side + "', type='" + type + "', qty=" + qty + ", filledQty=" + filledQty + ", price=" + price + ", avgPrice=" + avgPrice + ", status='" + status + "', rejectReason='" + rejectReason + "'}";
    }
