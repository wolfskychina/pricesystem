...
public class MarketDataEvent extends BaseEvent {
    ...
    public String toString() {
        return "MarketDataEvent{symbol='" + symbol + "', bidPrice=" + bidPrice + ", askPrice=" + askPrice + ", lastPrice=" + lastPrice + ", bidQty=" + bidQty + ", askQty=" + askQty + ", lastQty=" + lastQty + ", volume=" + volume + ", timestamp=" + timestamp + "}";
    }
